...
CREATE TABLE `EstablecimientoEspecialidad` (
    ...
    `horariosDisponibles` TEXT NULL,

    INDEX `EstablecimientoEspecialidad_establecimientoId_idx`(`establecimientoId`),
    INDEX `EstablecimientoEspecialidad_especialidadId_idx`(`especialidadId`),
    UNIQUE INDEX `EstablecimientoEspecialidad_establecimientoId_especialidadId_key`(`establecimientoId`, `especialidadId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `EstablecimientoEspecialidad` ADD CONSTRAINT `EstablecimientoEspecialidad_establecimientoId_fkey` FOREIGN KEY (`establecimientoId`) REFERENCES `Establecimiento`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `EstablecimientoEspecialidad` ADD CONSTRAINT `EstablecimientoEspecialidad_especialidadId_fkey` FOREIGN KEY (`especialidadId`) REFERENCES `Especialidad`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
